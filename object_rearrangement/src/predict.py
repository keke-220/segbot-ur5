...
tf.flags.DEFINE_string("data_dir", "Data_zoo/MIT_SceneParsing/",
                       "path to dataset")
...
tf.flags.DEFINE_string("test_result_dir", "log/temp_result/",
...
def main(argv=None):
    ...
    for filename in os.listdir(test_image_folder):
        ...
        test_record['annotation'] = os.path.join(
    ...
    for i in range(0, len(predict_images)):
        utils.save_image(predict_images[i].astype(np.uint8),
                         FLAGS.test_result_dir,
                         name="inp_" + str(i))

        #utils.save_image(predict_annotations[i].astype(np.uint8), FLAGS.test_result_dir, name="gt_"+str(i))
        utils.save_image(pred[i].astype(np.uint8),
                         FLAGS.test_result_dir,
                         name="pred_" + str(i))
